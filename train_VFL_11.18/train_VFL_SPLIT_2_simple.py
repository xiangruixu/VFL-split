...
if __name__ == '__main__':
    ...
    if dataset == 'bank_marketing':
        if acti == 'leakyrelu_2':
          client_model_1 = Client_LinearNet_1_em_bm(in_dim=10, n_hidden_1=256,  n_hidden_2=num_cutlayer, client=1).to(device)
          client_model_2 = Client_LinearNet_1_em_bm(in_dim=5, n_hidden_1=256,  n_hidden_2=num_cutlayer, client=2).to(device)
          client_model_3 = Client_LinearNet_1_em_bm(in_dim=5, n_hidden_1=256,  n_hidden_2=num_cutlayer, client=3).to(device)
          server_model = Server_LeakyreluNet_1(n_hidden_2=num_cutlayer*3, n_hidden_3=num_cutlayer, n_hidden_4=64, n_hidden_5=32, out_dim=2).to(device)
