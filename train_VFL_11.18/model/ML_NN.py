...
class LeakyreluNet_bm_2(nn.Module):
    def __init__(self, in_dim=7, n_hidden_1=256, n_hidden_2=600, n_hidden_3=256, n_hidden_4=128, n_hidden_5=64, out_dim=2):
        super(LeakyreluNet_bm_2, self).__init__()
...
class LeakyreluNet_1_bm_1(nn.Module):
    def __init__(self, in_dim=7, n_hidden_1=256, n_hidden_2=600, n_hidden_3=256, n_hidden_4=128, n_hidden_5=64, out_dim=2):
        super(LeakyreluNet_1_bm_1, self).__init__()
    ...
    def forward(self, x, noise_scale):
        ...
        layer1_out = self.layer1(x)
        noise1 = np.random.normal(0, math.sqrt(noise_scale), layer1_out.size())
        noise1 = torch.from_numpy(noise1).float().cuda()
        layer1_out = (layer1_out + noise1).clone().detach().requires_grad_(True)

        layer2_out = self.layer2(layer1_out + noise1)
...
class LeakyreluNet_1_bm_2(nn.Module):
    def __init__(self, in_dim=7, n_hidden_1=256, n_hidden_2=600, n_hidden_3=256, n_hidden_4=128, n_hidden_5=64, out_dim=2):
        super(LeakyreluNet_1_bm_2, self).__init__()
