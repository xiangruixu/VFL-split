...
# Define model
class LeakyreluNet_bm_head_2(nn.Module):
    def __init__(self, in_dim=7, n_hidden_1=256, n_hidden_2=200, n_hidden_3=128, n_hidden_4=64, n_hidden_5=32, out_dim=2):
        super(LeakyreluNet_bm_head_2, self).__init__()
...
# Define model
class LeakyreluNet_1_bm_head_1(nn.Module):
    def __init__(self, in_dim=7, n_hidden_1=256, n_hidden_2=200, n_hidden_3=128, n_hidden_4=64, n_hidden_5=32, out_dim=2):
        super(LeakyreluNet_1_bm_head_1, self).__init__()
                                
        self.layer1_1 = nn.Sequential(nn.Linear(10, n_hidden_2),
)

        self.layer1_2 = nn.Sequential(nn.Linear(16, n_hidden_2),)

        self.layer1_3 = nn.Sequential(nn.Linear(31, n_hidden_2), )

   
        self.layer2 = nn.Sequential(nn.Linear(3*n_hidden_2, out_dim),
                                   )
...
# Define model
class LeakyreluNet_1_bm_head_2(nn.Module):
    def __init__(self, in_dim=7, n_hidden_1=256, n_hidden_2=200, n_hidden_3=128, n_hidden_4=64, n_hidden_5=32, out_dim=2):
        super(LeakyreluNet_1_bm_head_2, self).__init__()
